...
if __name__ == '__main__':
    for m in range(0,len(maps)):
        ...
        permissible_region[array_255==0] = 1 # Numpy array of dimension (map_msg.info.height, map_msg.info.width),# With values 0: not permissible, 1: permissible
        ...
        sensor_model = SensorModel("/fake_topic1", 18, True,
                        11.0, map_msg, particles, weights,0.33)
